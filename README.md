...
The following steps are optional since all the required data provided with the github repo. However, if you would like to start from scratch, I have a few thoughts. 
